...
namespace JobFixa.Controllers
{
    public class EmployerController : Controller
    {
        ...
        public EmployerController(JobFixaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Employers != null ? 
                          ...
                          Problem("Entity set 'JobFixaContext.Employer'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("EmployerId,Name,Industry,Address,Logo,DateCreated,DateModified")] Employer employer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("EmployerId,Name,Industry,Address,Logo,DateCreated,DateModified")] Employer employer)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(Guid id)
        {
            ...
            {
                return Problem("Entity set 'JobFixaContext.Employer'  is null.");
            }
            var employer = await _context.Employers.FindAsync(id);
            if (employer != null)
            {
